...
public class ActivityInfoReuqest extends BizRequest {
    public ActivityInfoReuqest(String requestJson){
        try {
    ...
    public ActivityInfoReuqest(byte[] requestJson){
        try {
    ...
    {
        return CarairConstants.REQUEST_URL+"/app/activityinfo";
    }
}
