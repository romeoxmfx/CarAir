...
public class ConfigSetRequest extends BizRequest {
    
    public ConfigSetRequest(String requestJson) {
        try {
    ...
    public ConfigSetRequest(byte[] requestJson) {
        try {
    ...
    {
        return CarairConstants.REQUEST_URL+"/app/configset";
    }
}
