...
public class PhoneInfo
{
	...
	{
		String imei = null;
		SharedPreferences sp = MunionConfigManager.getInstance().getContext()
				.getSharedPreferences(IMEI, Context.MODE_PRIVATE);
		imei = sp.getString(IMEI, null);
		if (imei == null || imei.length() == 0)
		{
			TelephonyManager tm = (TelephonyManager) MunionConfigManager.getInstance().getContext()
	...
	{
		WifiManager wifi = (WifiManager) MunionConfigManager.getInstance().getContext()
		...
		{
			SharedPreferences sp = MunionConfigManager.getInstance().getContext()
					.getSharedPreferences(MACADDRESS, Context.MODE_PRIVATE);
	 ...
	 */
	static public String getOriginalImei()
	{
	 ...
	 */
	static public String getOriginalImsi()
	{
	...
	{
		String androidId = Settings.Secure.getString(MunionConfigManager.getInstance().getContext()
	...
	public static float getDeviceDensity()
	{
		if (metrics == null)
		{
			WindowManager windowMgr = (WindowManager) MunionConfigManager.getInstance().getContext()
	...
	public static PackageInfo getAppInfo()
	{
		...
		try
		{
			info = MunionConfigManager.getInstance().getContext().getPackageManager()
					.getPackageInfo(MunionConfigManager.getInstance().getContext().getPackageName(), 0);
	...
	public static int getScreenWidthWithDp()
	{
		if (screenWidthDp == 0)
		{
	...
	public static double getScreenSizeWithInch()
	{
		if (screenInch == 0)
		{
			if (metrics != null)
			{
				screenInch = Math.sqrt(Math.pow((metrics.widthPixels / metrics.xdpi), 2)
